...
How to proceed:
1) Call the tool 'pdf_extract_text' to extract the text from the provided PDF file:
...
2) Once you have the extracted text, extract the required fields:
    ...
    - The passage text:
        - Some questions may have a passage before the statement that should be included.
        - If there is no passage, return an empty string for this field.
        - May contain the source of the passage text.
        - The source of the passage text must be stored in the Sources field, following the instructions provided.
        - The source of the passage should not be included in the passage text itself.
